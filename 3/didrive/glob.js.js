...
//
//
//    $('body .select_edit_item_dop02').change(function (event) {
...
//        $.ajax({
//
//            xurl: "/vendor/didrive_mod/items/1/didrive/ajax.php",
...
//
//// не доделанная штука 
//// перенёс в универсальный base ... при клике передавать атрибуты в аякс и возвращать результат
//    $(document).on('click', '.items__record_new_item', function (event) {
//
//        console.log('.items__record_new_item', '/nyos_mod/items/1/didrive/glob.js.js');
//
////        return false;
//
//        //alert('2323');
